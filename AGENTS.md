...
This project is indexed by GitNexus as **dograh** (46930 symbols, 98310 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/dograh/context` | Codebase overview, check index freshness |
| `gitnexus://repo/dograh/clusters` | All functional areas |
| `gitnexus://repo/dograh/processes` | All execution flows |
| `gitnexus://repo/dograh/process/{name}` | Step-by-step execution trace |
