...
2. Create a new application (or open the existing one whose name you configured in Dograh) with these settings:
   ...
   - **Application URL**: `https://your-backend.example.com/api/v1/telephony/inbound/run`
   - **HTTP Method**: `POST`
...
4. Save
   ...
   <Note>
     ...
     Either works. Use your deployment's backend domain in this URL.
   </Note>
...
3. Confirm:
   - **URL** is set to: `https://your-backend.example.com/api/v1/telephony/inbound/run`
   - **Method** is `POST`
