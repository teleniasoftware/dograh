...
description: "Configure inbound calling for Twilio, Vonage, Plivo, Telnyx, and Asterisk ARI providers in Dograh AI"
---
...
```
https://your-backend.example.com/api/v1/telephony/inbound/run
```
...
<Note>
Use your deployment's backend domain in this URL.
</Note>
