...
- An existing agent ID to save drafts against. Create one in the Dograh UI or via [`POST /api/v1/workflow/create/definition`](/api-reference/agents/create-from-definition).
