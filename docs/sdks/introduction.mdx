...
Generate an API key at `/api-keys` in your deployment, or `http://localhost:3010/api-keys` for local development. See [API Keys](/configurations/api-keys) for details.
