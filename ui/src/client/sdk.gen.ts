 ...
 */
export const createWorkflowFromTemplateApiV1WorkflowCreateTemplatePost = <ThrowOnError extends boolean = false>(options: Options<CreateWorkflowTemplateApiV1WorkflowCreateTemplatePostData, ThrowOnError>) => {
    return (options.client ?? client).post<CreateWorkflowTemplateApiV1WorkflowCreateTemplatePostResponses, CreateWorkflowTemplateApiV1WorkflowCreateTemplatePostErrors, ThrowOnError>({
